...
HEADERS=constants.h lodepng.h static/models/myCube.h static/models/myTeapot.h shaderprogram.h src/player/movement.h src/player/camera.h
FILES=lodepng.cpp main_file.cpp shaderprogram.cpp src/player/movement.cpp src/player/camera.cpp
